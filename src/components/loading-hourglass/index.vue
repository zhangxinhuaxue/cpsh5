    ...
    <transition name="fade">
        ...
        >
            <div class="mui-toast__content">
                <svg class="hourglass" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"
                     preserveAspectRatio="xMidYMid" >
                    <rect x="0" y="0" width="100" height="100" fill="none" class="bk"></rect>
                    <g>
                        <path fill="none" stroke="#fff" stroke-width="5" stroke-miterlimit="10"
                        ...
                        <path d="M29,23c3.1,11.4,11.3,19.5,21,19.5S67.9,34.4,71,23H29z"
                              clip-path="url(#uil-hourglass-clip1)" fill="#fff" class="sand"></path>
                        <path d="M71.6,78c-3-11.6-11.5-20-21.5-20s-18.5,8.4-21.5,20H71.6z"
                              clip-path="url(#uil-hourglass-clip2)" fill="#fff" class="sand"></path>
                ...
                <p class="mui-toast__txt">{{content}}</p>
            </div>
        </m-popup>
    </transition>
</template>
