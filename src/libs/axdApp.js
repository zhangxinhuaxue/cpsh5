 ...
 */
import './jsbridge'
import {  isZjl, isMjb, newerVersionThan } from './util'
(function() {
    // const isZJL = navigator.userAgent.match(/\"appName\":\"(.*?)\"/) && navigator.userAgent.match(/\"appName\":\"(.*?)\"/)[1] === 'ZJL'
    var core = {
        isNewApi: isZjl || isMjb || newerVersionThan('4.2.7'),
        // isNewApi: !!window.JSBridge,
        checkCount: 1,
        nativeApp: null,
        ...
        newApi: function(args) {
            ...
            var postData = Object.assign(defData, args)
