(function() {
    ...
    var rotate = function(parameters) {
        var ele  = parameters.ele;
        if (ele.length === 0 || typeof parameters == "undefined") return;
        if (typeof parameters == "number") parameters = {
            angle: parameters
        };
        var returned = [];
        for (var i = 0, i0 = ele.length; i < i0; i++) {
            var element = ele[i];
            if (!element.Wilq32 || !element.Wilq32.PhotoEffect) {

                var paramClone = Object.assign(true, {}, parameters);
